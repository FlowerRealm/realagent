...
std::string_view protocol_name(Protocol p) {
    switch (p) {
        case Protocol::AnthropicMessages: return "anthropic-messages";
        case Protocol::OpenAiChat: return "openai-chat";
        case Protocol::OpenAiResponses: return "openai-responses";
    }
    return "";
}
...
SseParser::SseParser(Protocol p) {
    switch (p) {
        case Protocol::AnthropicMessages: st_ = AnthropicState{}; break;
        case Protocol::OpenAiChat: st_ = OpenAiChatState{}; break;
        case Protocol::OpenAiResponses: st_ = OpenAiResponsesState{}; break;
    }
}
